...
from kiln_controller.client.helpers import (trace, logger as helper_logger, detect_bad_url)
...
class _TestHandler(logging.Handler):
    ...
    def emit(self, record) -> None:
        self.emitted.append((record.levelno,
    ...
    def test_detect_bad_url(self):
        ...
        for (exc_type, bad_url) in (
            ...
            with self.assertRaises(exc_type,
                                   msg=f"bad url not detected: '{bad_url}'"):
                test.test(bad_url)
