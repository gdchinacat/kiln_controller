...
class PhaseTest(CleanupTestCase):
    ...
    def phase_generator(self, schedule):
        ...
        while kwargs is not None:
            ...
            kwargs = yield Phase(ordinal=next(ordinal),
                                 parent=schedule,
                                 **kwargs)
    ...
    @fixture(user_fixture)
    @fixture(schedule_fixture)
    def test_sequential_constant_phases_error(self, schedule, mock_service,
                                              **_):
        '''
    ...
    @fixture(user_fixture)
    @fixture(schedule_fixture)
    def test_discountinous_temperature_error(self, schedule,
                                             mock_service, **_):
